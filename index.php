<html>
		...
		<body background="five.jpg" >
            <center>
            <h1 >Compile Online</h1>
            </center>
			<form id="code" action="process.php" method="post">
				<div>
					<center>
						<label for="lang">Select Language:</br></label>
                	...
                	<div>
                		<center>
                			<label for="source">Source Code:</br></label>
                			<textarea cols="80" rows="15" name="source" id="source"></textarea>
                		</center>  
                	</div>

                	<div>
                		<center>
                			<label for="input">Stdin:</br></label>
                			<textarea cols="80" rows="5" name="input"></textarea>
                		</center>
                	</div>
                    ...
                    <div id="footer">
                     Written by: <a href="https://www.facebook.com/vivek.thakur.5283?ref=tn_tnmn">Vivek Thakur</a> <br> Using <a href="http://ideone.com">Ideone API</a> &copy;
